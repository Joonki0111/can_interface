...
class AwToCan : public rclcpp::Node 
{
    ...
    private:
        ...
        rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr TC_cart_velocity_status_pub_;
        ...
        rclcpp::Subscription<can_msgs::msg::Frame>::SharedPtr Cart_sub_can_;
        ...
        void Cart_can_data_callback(const can_msgs::msg::Frame::SharedPtr msg);
